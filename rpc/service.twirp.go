...
/*
Package helloservice is a generated twirp stub package.
...
func (c *helloWorldProtobufClient) Hello(ctx context.Context, in *HelloReq) (*HelloResp, error) {
	ctx = ctxsetters.WithPackageName(ctx, "helloservice")
...
const HelloWorldPathPrefix = "/twirp/helloservice.HelloWorld/"
...
func (s *helloWorldServer) ServeHTTP(resp http.ResponseWriter, req *http.Request) {
	...
	switch req.URL.Path {
	case "/twirp/helloservice.HelloWorld/Hello":
